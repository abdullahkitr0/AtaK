...
exports.run = async (client, message, args) => {
  ...
  .setAuthor('AtaK BOT', client.user.avatarURL)
  .setTitle('AtaK BOT', client.user.avatarURL)
  .setURL("https://discord.gg/KERamBW")
  .setDescription("sunucutanıt Kullandınız.")
  .addField('Sizin Sunucunuz Burada Tanıtıldı', `[Tıkla](https://discord.gg/KERamBW)`)
        .setTimestamp()
